...
const MATH: Record<Grade, Row[]> = {
  "K": [
    ...
    ["teens-place-value", "Teen numbers as ten ones and some more ones", NBT],
    ["measurable-attributes", "Compare length, height and weight", MD],
    ["classify-count", "Sort objects into categories and count them", MD],
    ["shapes-2d-3d", "Identify 2D and 3D shapes", G],
  ],
  "1": [
    ["add-sub-20", "Add and subtract within 20", OA, ["m.K.add-sub-10", "m.K.make-10"]],
    ["addition-properties", "Commutative and associative properties of addition", OA, ["m.K.add-sub-10"]],
    ["equal-sign", "Meaning of the equal sign and missing addends", OA],
    ...
    ["measure-nonstandard", "Measure length with non-standard units", MD, ["m.K.measurable-attributes"]],
    ["time-half-hour", "Tell time to the hour and half hour", MD],
    ["data-3-categories", "Organize and read data with up to three categories", MD, ["m.K.classify-count"]],
    ["halves-fourths", "Partition shapes into halves and fourths", G, ["m.K.shapes-2d-3d"]],
  ],
  "2": [
    ...
    ["thirds-polygons", "Partition into thirds; identify polygons by sides and angles", G, ["m.1.halves-fourths"]],
  ],
  "3": [
